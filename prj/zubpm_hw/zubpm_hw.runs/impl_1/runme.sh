...
HD_PWD='/home/bouthsarath/ibert_dfe/prj/zubpm_hw/zubpm_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ibert_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ibert_test.tcl -notrace
