...
HD_PWD='/home/bouthsarath/ibert_dfe/prj/zubpm_hw/zubpm_hw.runs/ibert_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ibert.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ibert.tcl
