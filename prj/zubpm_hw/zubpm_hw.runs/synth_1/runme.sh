...
HD_PWD='/home/bouthsarath/ibert_dfe/prj/zubpm_hw/zubpm_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ibert_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ibert_test.tcl
